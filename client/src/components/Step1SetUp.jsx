...
function Step1SetUp({ onStart }) {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            ...
            console.log(error)
            setError(error.response?.data?.message || error.message || "Resume analysis failed")
            setAnalyzing(false);
        }
    }
    ...
    const handleStart = async () => {
        ...
        try {
           ...
           onStart(result.data)
            ...
            console.log(error)
            setError(error.response?.data?.message || error.message || "Interview start failed")
            setLoading(false)
        }
    }
    return (
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                        ...
                        {error && (
                            <div className='text-red-600 bg-red-100 border border-red-200 rounded-xl p-3 mb-4'>
                                {error}
                            </div>
                        )}
                        <motion.button
